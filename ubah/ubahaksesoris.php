<?php
    ...
    $aksesoris = query("SELECT * FROM admin_aksesoris WHERE id=$id")[0];
    

    if(isset ($_POST["submit"])){
        if (ubahaksesoris($_POST) > 0){
            echo "
                <script>
