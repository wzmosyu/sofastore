<?php
    ...
    $dakimakura = query("SELECT * FROM admin_dakimakura WHERE id=$id")[0];
    

    if(isset ($_POST["submit"])){
        if (ubahdakimakura($_POST) > 0){
            echo "
                <script>
...
<body>
    ...
    <br>
    <h3 class="container">EDIT DATA AKSESORIS</h3>
    <br>

    <div class="container">
        <form action="" method="post">
            <input type="hidden" name="id" value="<?= $dakimakura["id"]; ?>">
